...
pub const NORMAL_LAYER_MAPPING: [[KeyCode; NUM_ROWS]; NUM_COLS] = [
    ...
    [KeyCode::P,     KeyCode::U,     KeyCode::K,       KeyCode::Right,          KeyCode::Fn,KeyCode::RightCmd, KeyCode::Fn, KeyCode::Space],
    [KeyCode::Y,     KeyCode::I,     KeyCode::X,        KeyCode::Backspace, KeyCode::RightShift,KeyCode::RightCtrl, KeyCode::Empty, KeyCode::Empty],
];
...
pub const FN_LAYER_MAPPING: [[KeyCode; NUM_ROWS]; NUM_COLS] = [
    ...
    [KeyCode::Num9, KeyCode::Num6, KeyCode::Num3, KeyCode::R, KeyCode::Backspace, KeyCode::RightCmd, KeyCode::Backspace, KeyCode::Backspace],
    [KeyCode::F, KeyCode::G, KeyCode::C, KeyCode::R, KeyCode::Backspace, KeyCode::RightCmd, KeyCode::Backspace, KeyCode::Backspace],
];
